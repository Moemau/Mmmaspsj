...
try:
	#prox= requests.get('https://github.com/Moemau/Approved-/blob/main/Approved.txt').text
...
android_models=[]
try:
	#xx = requests.get('https://github.com/Moemau/Approved-/blob/main/Approved.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://github.com/Moemau/Approved-/blob/main/Approved.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/Moemau/Approved-/blob/main/Approved.txt').text
...
\033[1;92m******************************************\033[0m""")
  ...
  print(f"")
  try:
    httpCaht = requests.get("https://github.com/Moemau/Approved-/blob/main/Approved.txt").text
    if id in httpCaht:
